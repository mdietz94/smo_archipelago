...
def run_setup_wizard(smoap_path: str | None = None) -> bool:
    ...
    def build_welcome() -> Screen:
        ...
        msg = (
            ...
            "  - Switch firmware 21.2 or 22.x, OR an emulator. "
            "Both FW 21.2 and FW 22 are hands-on validated post-Hakkun-cutover; "
            "earlier firmware likely works but isn't tested. "
            "An emulator loads the same subsdk9 overlay as a mod and is "
            "fully supported.\n"
            ...
            "from scratch.\n\n"
            "This wizard will:\n"
            "  - Check that you have LLVM 19, CMake, Ninja, msys2 mingw64, "
            "hactool, Python 3.12, and your Switch prod.keys. (Ninja "
            "installs quickest with `winget install Ninja-build.Ninja` — "
            "close and reopen this app afterwards so PATH gets refreshed, "
